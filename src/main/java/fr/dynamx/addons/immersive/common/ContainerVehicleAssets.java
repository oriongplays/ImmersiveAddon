...
public class ContainerVehicleAssets extends Container {
        ...
        for(int i=0;i<9;i++) {
            ...
            this.addSlotToContainer(new Slot(inv, i, 8 + i*18, 20) {
                ...
                public boolean isItemValid(ItemStack stack) {
                    return stack.getItem() instanceof ItemVehiclePart && ((ItemVehiclePart) stack.getItem()).getSlotId().equals("asset");
                }
    ...
    private void updateModuleSlot(int slot) {
        ...
        module.setAsset(slot, stackToValue(stack));
    }
    ...
    public boolean canInteractWith(EntityPlayer playerIn) {
                // Client side does not have access to the persistent entity NBT,
        // so blindly denying access would immediately close the GUI.
        ...
        try {
            ...
            return owner.equals(playerIn.getUniqueID());
